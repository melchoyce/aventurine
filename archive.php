			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'Day: %s', 'aventurine' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'aventurine' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'aventurine' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
